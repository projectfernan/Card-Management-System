...
Public Class crtNotInserted
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "projTanza.crtNotInserted.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrtNotInserted
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crtNotInserted = New crtNotInserted
        rpt.Site = Me.Site
        Return rpt
    End Function
