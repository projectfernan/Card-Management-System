...
Module vbEncryption
    ...
    Function EncryptCode(ByVal Code As String) As String
        Dim plainText As String
        Dim cipherText As String
        ...
        plainText = Code     ' original plaintext

        passPhrase = "#i4@J@t3+Et9d"        ' can be any string
        saltValue = "+g4J#g@9-hE=28"         ' can be any string
        hashAlgorithm = "SHA1"          ' can be "MD5"
        passwordIterations = 28         ' can be any number
        initVector = "@1B2c3J4e5F6g7H8" ' must be 16 bytes
    ...
    Function DecryptCode(ByVal Code As String) As String
        Dim plainText As String
        Dim cipherText As String
