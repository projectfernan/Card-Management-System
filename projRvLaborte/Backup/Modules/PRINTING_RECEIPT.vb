...
Module PRINTING_RECEIPT
    ...
    Private Sub pdPrint_Print(ByVal sender As System.Object, ByVal e As PrintPageEventArgs) Handles pdPrint.PrintPage
        ...
        e.Graphics.DrawString(MainForm.txtOperator.Text, printFont, Brushes.Black, x + 85, y - 15)
        y += (lineOffset * 2.0)
        e.Graphics.DrawString("Station :", printFont, Brushes.Black, x, y - 15)
        e.Graphics.DrawString(MainForm.txtStation.Text, printFont, Brushes.Black, x + 85, y - 15)
        y += (lineOffset * 2.0)
    ...
    Public Sub SaveReciept()
        ...
        With MainForm
            ...
            RecieptList.Insert(16, MainForm.txtOperator.Text)
            RecieptList.Insert(17, MainForm.txtStation.Text)
